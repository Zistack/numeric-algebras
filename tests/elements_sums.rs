...
use numeric_algebras::derive::{def_scalar_arithmetic, def_elements_sum_traits};
use numeric_algebras::traits::ElementsSum;
...
fn elements_sums ()
{
	...
	(
		...
		(
			...
			AggregateType {x: 1.0, y: 2.0} . elements_sum ()
		),
		3.0
	);
}
